(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("react"), require("draft-js"), require("immutable"), require("lodash.debounce"), require("node-uuid"), require("ajv"), require("react-bootstrap"));
	else if(typeof define === 'function' && define.amd)
		define(["react", "draft-js", "immutable", "lodash.debounce", "node-uuid", "ajv", "react-bootstrap"], factory);
	else {
		var a = typeof exports === 'object' ? factory(require("react"), require("draft-js"), require("immutable"), require("lodash.debounce"), require("node-uuid"), require("ajv"), require("react-bootstrap")) : factory(root["react"], root["draft-js"], root["immutable"], root["lodash.debounce"], root["node-uuid"], root["ajv"], root["react-bootstrap"]);
		for(var i in a) (typeof exports === 'object' ? exports : root)[i] = a[i];
	}
})(this, function(__WEBPACK_EXTERNAL_MODULE_1__, __WEBPACK_EXTERNAL_MODULE_2__, __WEBPACK_EXTERNAL_MODULE_3__, __WEBPACK_EXTERNAL_MODULE_4__, __WEBPACK_EXTERNAL_MODULE_6__, __WEBPACK_EXTERNAL_MODULE_9__, __WEBPACK_EXTERNAL_MODULE_16__) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	TranscriptEditor.propTypes = {
	  transcript: _react2.default.PropTypes.object,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Transcript = __webpack_require__(8);

	var _Transcript2 = _interopRequireDefault(_Transcript);

	var _TranscriptSegment = __webpack_require__(10);

	var _TranscriptSegment2 = _interopRequireDefault(_TranscriptSegment);

	var _TranscriptWord = __webpack_require__(11);
	...
	var convertToTranscript = function convertToTranscript(contentState, speakers) {
	  var segments = contentState.getBlockMap().toArray().map(function (block) {
	    ...
	    block.findEntityRanges(function (character) {
	      ...
	      words.push(new _TranscriptWord2.default({
	  ...
	  return new _Transcript2.default({
